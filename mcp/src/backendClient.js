const OPERATIONS = Object.freeze({
  ...
  get_platform_revenue_summary: "/api/v1/assistant/get_platform_revenue_summary",
  list_seller_applications: "/api/v1/assistant/list_seller_applications",
  ...
  propose_cart_change: "/api/v1/assistant/propose_cart_change",
  propose_order_return: "/api/v1/assistant/propose_order_return",
  get_my_action_status: "/api/v1/assistant/get_my_action_status",
  propose_order_cancellation: "/api/v1/assistant/propose_order_cancellation",
  propose_listing_publish: "/api/v1/assistant/propose_listing_publish",
  propose_listing_content_change: "/api/v1/assistant/propose_listing_content_change",
  propose_price_change: "/api/v1/assistant/propose_price_change",
  propose_inventory_adjustment: "/api/v1/assistant/propose_inventory_adjustment",
  propose_fulfillment_transition: "/api/v1/assistant/propose_fulfillment_transition",
...
const PRIVATE_SCOPES = Object.freeze({
  ...
  get_platform_revenue_summary: Object.freeze(["platform:read"]),
  list_seller_applications: Object.freeze(["sellers:read"]),
  ...
  propose_cart_change: Object.freeze(["cart:propose"]),
  propose_order_return: Object.freeze(["returns:propose"]),
  get_my_action_status: Object.freeze(["proposals:read"]),
  propose_order_cancellation: Object.freeze(["orders:propose"]),
  propose_listing_publish: Object.freeze(["listings:propose"]),
  propose_listing_content_change: Object.freeze(["listings:propose"]),
  propose_price_change: Object.freeze(["pricing:propose"]),
  propose_inventory_adjustment: Object.freeze(["inventory:propose"]),
  propose_fulfillment_transition: Object.freeze(["fulfillment:propose"]),
