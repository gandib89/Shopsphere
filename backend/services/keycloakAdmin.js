...
export const ROLE_SCOPES = Object.freeze({
  ...
  seller: Object.freeze(["profile:read", "notifications:read", "catalog:read", "orders:read", "sales:read", "revenue:read", "listings:draft", "listings:propose", "pricing:propose", "fulfillment:propose"]),
